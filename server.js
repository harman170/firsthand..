...
app.post("/save-post", function(req, resp) {
    ...
    let contact = req.body.contact;
    console.log("Extracted values:", {jobtitle, jobtype, address, city, edu, contact});
    // jobid is auto-generated by the database; do not send from form

    mySqlServer.query(
        "INSERT INTO jobs (jobtitle, jobtype, address, city, edu, contact) VALUES (?, ?, ?, ?, ?, ?)",
        [jobtitle, jobtype, address, city, edu, contact],
        function(err) {
            if (err === null) {
